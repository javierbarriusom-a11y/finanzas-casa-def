(function attachCanonicalScenarioInvariants(root, factory) {
  ...
  const INVARIANTS = Object.freeze([
    ...
    { id: "I-05", nombre: "Neutralidad de inactivas", formulacion: "Una decisión con activa:false produce el mismo resultado que su ausencia", verificableHoy: false, motorActual: null },
    { id: "I-06", nombre: "Conmutatividad de independientes", formulacion: "Reordenar dos decisiones que no comparten deudaId, mes ni cuenta no cambia el resultado", verificableHoy: false, motorActual: null },
